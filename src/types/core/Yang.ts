...
export interface YangInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface Yang extends BaseContract {
  connect(runner?: ContractRunner | null): Yang;
  waitForDeployment(): Promise<this>;

  interface: YangInterface;
